...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
  ...
  <div class="input-group ">
    ...
    <input type="text" class="form-control" name="title" placeholder="" maxlength="13" value="<?php echo $id ? $article->title : ''; ?>" aria-describedby="sizing-addon1" required>
  </div>
  <div class="input-group ">
    <span class="input-group-addon" id="sizing-addon1" >描述</span>
    <input type="text" class="form-control" name="info" placeholder="" maxlength="40" value="<?php echo $id ? $article->info : ''; ?>" aria-describedby="sizing-addon1" required>
  </div>
  <div class="input-group ">
